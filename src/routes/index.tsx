...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Hamza Hasni — Software Developer" },
      {
        name: "description",
        content:
          "Hamza Hasni — Software Developer specializing in Node.js, React, Magento 2 & OpenSearch. Building clean, scalable web and mobile applications.",
      },
      { property: "og:title", content: "Hamza Hasni — Software Developer" },
      {
        property: "og:description",
        content:
          "Full-stack developer crafting modern web and mobile applications with Node.js, React, and Magento 2.",
      },
    ],
  }),
});
    ...
    <section id="about" className="mx-auto max-w-7xl px-6 py-24 md:py-32">
      ...
      <div className="grid gap-12 md:grid-cols-5">
        <div className="space-y-5 text-lg leading-relaxed text-muted-foreground md:col-span-3">
          ...
          <p>
            I focus on writing{" "}
            <span className="text-foreground">clean, efficient and maintainable</span>{" "}
        ...
        <div className="space-y-3 md:col-span-2">
          {[
            { icon: MapPin, label: "Location", value: "Ain Zaghouan, Tunis, Tunisia" },
            { icon: Mail, label: "Email", value: "hamza.hasnni@gmail.com" },
            { icon: Phone, label: "Phone", value: "(+216) 22 449 271" },
            { icon: Terminal, label: "Languages", value: "Arabic · English · French" },
...
const EXPERIENCE = [
  ...
  },
  {
    ...
    org: "GoMyCode",
    location: "Tunis, Tunisia",
    bullets: ["Intensive MERN stack bootcamp — MongoDB, Express, React, Node.js."],
  },
];
...
function Work() {
  return (
    <section id="work" className="mx-auto max-w-7xl px-6 py-24 md:py-32">
      ...
      <ol className="relative space-y-12 md:pl-8 md:border-l md:border-border">
        {EXPERIENCE.map((e) => (
...
const STACK = [
  {
    icon: Code2,
    title: "Frontend",
    items: ["React.js", "TypeScript", "HTML / CSS", "Bootstrap", "Flutter (mobile)"],
  },
  {
    icon: Server,
    title: "Backend",
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        ...
        <h2 className="font-display mt-4 text-4xl font-bold md:text-6xl text-balance">
